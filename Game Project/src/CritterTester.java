...
public class CritterTester {
		Critter test = new Critter(0, 0, 0, 0, 0, false, false, 0, 0, 0);
		Critter test2 = new Critter(10, 10, 10, 10, 10, true, true, 10, 10, 10);
		Critter test3 = new Critter(100, 100, 100, 100, 100, true, false, 100, 100, 100);
