...
public class OysterTest {
	Oyster test = new Oyster(0, 0, 0, 0, 0, false, false, 0, 0, 0);
	Oyster test2 = new Oyster(10, 10, 10, 10, 10, true, true, 10, 10, 10);
	Oyster test3 = new Oyster(100, 100, 100, 100, 100, true, false, 100, 100, 100);
...
@Test
public void bubbleTesterX1(){
	int shouldbe = test.getX();
	assertEquals(shouldbe, test.Bubble().getXWLoc() );
	
}
@Test
public void bubbleTesterY1(){
	int shouldbe = test.getY();
	assertEquals(shouldbe, test.Bubble().getYWLoc() );
	
}
@Test
public void bubbleTesterX2(){
	int shouldbe = test2.getX();
	assertEquals(shouldbe, test2.Bubble().getXWLoc() );
	
}
@Test
public void bubbleTesterY2(){
	int shouldbe = test2.getY();
	assertEquals(shouldbe, test2.Bubble().getYWLoc() );
	
}
@Test
public void bubbleTesterX3(){
	int shouldbe = test3.getX();
	assertEquals(shouldbe, test3.Bubble().getXWLoc() );
	
}
@Test
public void bubbleTesterY3(){
	int shouldbe = test3.getY();
	assertEquals(shouldbe, test3.Bubble().getYWLoc() );
