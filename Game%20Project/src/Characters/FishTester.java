...
public class FishTester {
	Fish test = new Fish(0,0,0,0,0,true,true,0,0,0,0);
	Fish test2 = new Fish(10,10,10,10,10,true,false,10,10,10,10);
	Fish test3 = new Fish(100,100,100,100,100,false,false,100,100,100,100);
	...
	@Test
	public void getDropValTest1(){
		int shouldbe = 0;
		assertEquals(shouldbe, test.getDValue());
	}
	@Test
	public void getDropValTest2(){
		int shouldbe = 10;
		assertEquals(shouldbe, test2.getDValue());
	}
	@Test
	public void getDropValTest3(){
		int shouldbe = 100;
	...
	*/
	...
	@Test
	public void getCompColTest1(){
		int shouldbe = 0;
		assertEquals(shouldbe, test.getCompostCol());
	}
	@Test
	public void getCompColTest2(){
		int shouldbe = 10;
		assertEquals(shouldbe, test2.getCompostCol());
	}
	@Test
	public void getCompColTest3(){
		int shouldbe = 100;
		assertEquals(shouldbe, test3.getCompostCol());
	}
	@Test
