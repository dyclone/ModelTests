...
public class ConcreteWallTester {
	ConcreteWall b1=new ConcreteWall(5,50,50,10);
	ConcreteWall b2=new ConcreteWall(5,6,7,8);
	ConcreteWall b3=new ConcreteWall(1,2,3,4);
	@Test
	public void test() {
		//geters
